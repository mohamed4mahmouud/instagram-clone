                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-8">
                                        <a href=""><i class="fa-regular fa-heart fa-lg text-white ms-0"></i></a>
                                        <i class="fa-regular fa-comment fa-lg text-white ms-2"></i>
                                ...
                                <div class="row text-white">
                                    <div class="col-md-8 mt-1">
                                        ...
                                        <small>Liked by <strong>Janet-t</strong> and <strong>{{$post->like_count}}</strong> others</small>
                                    </div>
                                </div>
                                {{-- Caption --}}
                                <div class="row text-white">
